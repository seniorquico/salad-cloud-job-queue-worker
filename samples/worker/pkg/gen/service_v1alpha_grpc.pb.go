...
func (c *jobQueueWorkerServiceClient) AcceptJobs(ctx context.Context, in *AcceptJobsRequest, opts ...grpc.CallOption) (JobQueueWorkerService_AcceptJobsClient, error) {
	stream, err := c.cc.NewStream(ctx, &JobQueueWorkerService_ServiceDesc.Streams[0], "/salad.grpc.saladcloud_job_queue_worker.v1alpha.JobQueueWorkerService/AcceptJobs", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *jobQueueWorkerServiceClient) CompleteJob(ctx context.Context, in *CompleteJobRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/salad.grpc.saladcloud_job_queue_worker.v1alpha.JobQueueWorkerService/CompleteJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobQueueWorkerServiceClient) RejectJob(ctx context.Context, in *RejectJobRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/salad.grpc.saladcloud_job_queue_worker.v1alpha.JobQueueWorkerService/RejectJob", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _JobQueueWorkerService_CompleteJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/salad.grpc.saladcloud_job_queue_worker.v1alpha.JobQueueWorkerService/CompleteJob",
	}
...
func _JobQueueWorkerService_RejectJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/salad.grpc.saladcloud_job_queue_worker.v1alpha.JobQueueWorkerService/RejectJob",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var JobQueueWorkerService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "service_v1alpha.proto",
}
